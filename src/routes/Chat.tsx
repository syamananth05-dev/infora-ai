    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-surface-200 bg-surface-50 px-4 py-3 dark:border-surface-800 dark:bg-surface-900">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="rounded-2xl border border-surface-200 bg-white shadow-soft focus-within:border-accent-500/60 dark:border-surface-700 dark:bg-surface-950">
            <textarea
